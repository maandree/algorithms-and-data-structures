...
/**
 * Circular doubly linked list class. A linked list
 ...
 * Additionally, a circularly linked list, has stores
 * no references nodes, you must keep track of at least
 * one node yourself; instead the nodes form a circular
 * chain, there is no beginning and no end. This
